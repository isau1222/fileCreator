...
5. С сорцмапами имеются проблемы:
   ...
   - SFC оставляют за собой по несколько сорцмапов, которые попадают в корень
     вместо правильной директории.
...
7. Кеширование HTML. В некоторых ситуациях полезно, однако использовать
